...
<head>
    ...
    <link rel="stylesheet" href="./visual22.css">
    <!-- Favicon-->
        ...
        <div class="sub_header">
            ...
            <div class="hamburger" id="hamburger">
                <div class="bot_buscar2">
                    <a href="javascript:history.back()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-square" viewBox="0 0 16 16">
